...
<table  class="altrowstable" width="100%">
    ...
    <td><button type="submit" class="btn btn-primary">提交</button>    <button type="reset" >重置</button>  </td><td>  <button type="button"  onclick="location.href='ClassinfoSvl'" >返回</button></td>
	</tr>
</table>
